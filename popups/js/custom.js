...
$(document).ready(function() {
    ...
    jQuery('#sidebar-menu').find('a').on('click', function(ev) {
        ...
        if ($li.is('.active')) {
            ...
            if (!$li.parent().is('.child_menu')) {
                jQuery('#sidebar-menu').find('li').removeClass('active');
    ...
    $MENU_TOGGLE.on('click', function() {
        if ($BODY.hasClass('nav-md')) {
            ...
            if (jQuery('#sidebar-menu').find('li').hasClass('active')) {
                jQuery('#sidebar-menu').find('li.active').addClass('active-sm').removeClass('active');
            }
        } else {
            $BODY.removeClass('nav-sm').addClass('nav-md');

            if (jQuery('#sidebar-menu').find('li').hasClass('active-sm')) {
    ...
    // check active menu
/*    jQuery('#sidebar-menu').find('a[href="' + URL + '"]').parent('li').addClass('current-page').addClass('active');
