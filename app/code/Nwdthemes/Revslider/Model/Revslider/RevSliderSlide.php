...
class RevSliderSlide extends \Nwdthemes\Revslider\Model\Revslider\Framework\RevSliderElementsBase {
	...
	public function initByPostData($postData, RevSliderSlide $slideTemplate, $sliderID){
		...
		if(!empty($slideTemplateID) && is_numeric($slideTemplateID)){
			...
			try{
				...
				$slideTemplateLocal = new RevSliderSlide($this->_framework, $this->_query, $this->_curl, $this->_filesystem, $this->_images, $this->_resource, $this->_googleFonts);
	...
	public function getParentSlide(){
		...
		$parentSlide = new RevSliderSlide($this->_framework, $this->_query, $this->_curl, $this->_filesystem, $this->_images, $this->_resource, $this->_googleFonts);
	...
	public function getUsedFonts($full = false){
		...
		$op = new RevSliderOperations($this->_framework, $this->_query, $this->_curl, $this->_filesystem, $this->_images, $this->_resource, $this->_googleFonts);
		$fonts = array();
