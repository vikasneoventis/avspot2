...
class RevSliderBaseAdmin extends RevSliderBase {
	...
	public static function addCommonScripts(){
		...
		self::$framework->wp_enqueue_style('unite_admin', Framework::$RS_PLUGIN_URL .'admin/assets/css/admin.css', array(), RevSliderGlobals::SLIDER_REVISION);
		...
		self::$framework->wp_enqueue_style('tipsy', Framework::$RS_PLUGIN_URL .'admin/assets/css/tipsy.css', array(), RevSliderGlobals::SLIDER_REVISION);
		...
		self::$framework->wp_enqueue_style('codemirror_css', Framework::$RS_PLUGIN_URL .'admin/assets/js/codemirror/codemirror.css', array(), RevSliderGlobals::SLIDER_REVISION);
	...
	protected static function addActionAjax($ajaxAction,$eventFunction){
		self::$framework->add_action('wp_ajax_revslider_'.$ajaxAction, array('RevSliderAdmin', $eventFunction));
	}
