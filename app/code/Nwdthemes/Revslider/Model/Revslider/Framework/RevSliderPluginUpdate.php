...
class RevSliderPluginUpdate {
	...
	public static function get_version(){
		$real_version = $this->_framework->get_option('revslider_update_version', 1.0);
	...
	public static function set_version($set_to){
		...
		$this->_framework->update_option('revslider_update_version', $set_to);
	...
	public static function move_template_slider(){
		...
		$sr = new RevSliderSlider(self::$framework, self::$query, self::$curl, self::$filesystem, self::$images, self::$resource, self::$googleFonts);
		$sl = new RevSliderSlide(self::$framework, self::$query, self::$curl, self::$filesystem, self::$images, self::$resource, self::$googleFonts);
